...
class IOSBuilder extends _BaseBuilder().default {
  ...
  maybeExplainUploadStep() {
    ...
    _log().default.log(`You can now publish to the App Store with ${TerminalLink().transporterAppLink()} or ${_chalk().default.bold('eas submit --platform ios')}. ${TerminalLink().learnMore('https://docs.expo.io/distribution/uploading-apps/')}`);
