...
function _default(program) {
  (0, _applyAsyncAction().applyAsyncActionProjectDir)(program.command('url [path]').alias('u').helpGroup('url').option('-w, --web', 'Return the URL of the web app').description('Log a URL for opening the project in Expo Go').urlOpts().allowOffline(), () => Promise.resolve().then(() => _interopRequireWildcard(require('./url/urlAsync'))));
