...
function getHermesCommand(projectRoot) {
    const platformExecutable = getHermesCommandPlatform();
    const resolvedPath = resolve_from_1.default.silent(projectRoot, `hermes-engine/${platformExecutable}`);
    if (!resolvedPath) {
        throw new Error(`Missing module "hermes-engine/${platformExecutable}" in the project.` +
...
function importMetroSourceMapFromProject(projectRoot) {
    const resolvedPath = resolve_from_1.default.silent(projectRoot, 'metro-source-map/src/composeSourceMaps');
    if (!resolvedPath) {
        throw new Error('Missing module "metro-source-map/src/composeSourceMaps" in the project. ' +
