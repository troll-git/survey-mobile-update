...
function constructBundleQueryParamsWithConfig(projectRoot, opts, exp) {
  ...
  const supportsAssetPlugins = _internal().Versions.gteSdkVersion(exp, '11.0.0');

  const usesAssetPluginsQueryParam = supportsAssetPlugins && _internal().Versions.lteSdkVersion(exp, '32.0.0');
...
function resolveProtocol(projectRoot, {
  ...
  if (detach) {
    ...
    if (firstScheme && _internal().Versions.gteSdkVersion({
      sdkVersion
    }, '27.0.0')) {
