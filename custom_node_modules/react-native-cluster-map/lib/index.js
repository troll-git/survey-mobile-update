...
const ClusterMarker = (props) => {
    ...
    return (React.createElement(GoogleMapView.Marker, { coordinate: { longitude, latitude }, onPress: onClusterPress }, children || (React.createElement(reactNative.View, { style: styles.clusterBox },
        ...
        this.createGeoJsonFeature = (element) => {
            return ({
                ...
                geometry: {
                    type: 'Point',
                    coordinates: [
                        element.props.coordinate ? element.props.coordinate.longitude : ((element.props.coordinates[0].longitude + element.props.coordinates[1].longitude) / 2),
                        element.props.coordinate ? element.props.coordinate.latitude : ((element.props.coordinates[0].latitude + element.props.coordinates[1].latitude) / 2),
                    ],
                },
                properties: { element },
            })
    ...
    constructor() {
        ...
        this.renderMarkers = () => {
            ...
            return markers.map((marker) => {
                ...
                return (React.createElement(ClusterMarker, { pointCount: point_count, coordinates: geometry.coordinates, onClusterMarkerPress: this.onClusterMarkerPress, clusterId: marker.properties.cluster_id, key: key }, renderClusterMarker && renderClusterMarker(point_count)));
            });
        };
        this.onMapReady = () => {
            this.setState({
